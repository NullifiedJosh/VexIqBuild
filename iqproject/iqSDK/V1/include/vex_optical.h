...
namespace vex {
  ...
  class optical : public device {
    ...
    public:
      ...
      /**
       * @brief Gets the detected color as a colorType
       * @return Returns a colorType that represents the name of the closest color detected to twelve possible values.
       */
