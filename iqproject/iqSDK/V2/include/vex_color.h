...
namespace vex {
    ...
    */
    class color {
        friend bool operator==(const vex::color& lhs, const vex::colorType& rhs) { return lhs._colorType() == rhs; }
        friend bool operator==(const vex::colorType& lhs, const vex::color& rhs) { return lhs == rhs._colorType(); }
        ...
        private:
          ...
          // conversion to colorType enum
          colorType _colorType() const;
        ...
        public:
          ...
          */
          ...
          /**
           *@brief Represents the color red_violet.
           */
          static const color    red_violet;
          /**
           *@brief Represents the color red_violet.
           */
           ...
           *@brief Represents the color red_violet.
           */
          static const color    yellow_orange;
          /**
           *@brief Represents the color red_violet.
           */
          static const color    red_orange;
    };
}
