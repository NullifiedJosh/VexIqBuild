  ...
  class motor : public device {
    public:
      ...
      */
      ...
      // these are all compatibility function and do not return any valid values
      ...
      /** 
       * @brief Get the type of the motor, Not used on IQ2
       * @return Returns the type of the motor, 0 standard IQ motor
       */
