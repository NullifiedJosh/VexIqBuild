...
namespace vex {
  ...
  class smartdrive : public drivetrain  {
    public:  
      smartdrive( motor_group &l, motor_group &r, vex::guido &g, double wheelTravel=200, double trackWidth=200, double wheelBase=50, distanceUnits unit=distanceUnits::mm, double externalGearRatio = 1.0 );
      smartdrive( vex::motor &l, vex::motor &r, vex::guido &g, double wheelTravel=200, double trackWidth=200, double wheelBase=50, distanceUnits unit=distanceUnits::mm, double externalGearRatio = 1.0 );
