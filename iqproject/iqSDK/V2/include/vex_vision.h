  ...
  */
  class vision : public device {
      ...
      */  
      class object {          
        ...
        public:
           ...
           */
          void      set( IQ_DeviceVisionObject obj );
    ...
    class code {
      ...
      bool            setSignature( IQ_DeviceVisionSignature *settings );
      bool            getSignature( IQ_DeviceVisionSignature *settings );
    ...
    private:
      ...
      IQ_DeviceVisionObject _objects[ VISION_MAX_OBJECTS ];
